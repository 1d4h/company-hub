...
### 🆕 주요 변경사항 (v1.3)
1. ✅ **카카오 간편 로그인** - 카카오 계정으로 간편 로그인 및 자동 회원가입
2. ✅ **카카오톡 채팅 상담** - 지도 화면에서 카카오톡 채널 채팅 버튼 추가
3. ✅ **사용자 프로필** - 카카오 프로필 사진 및 닉네임 자동 설정
4. ✅ **데이터베이스 확장** - Supabase users 테이블에 카카오 로그인 필드 추가

### 🔄 이전 버전

### 📦 v1.2-kakao-complete (2026-02-03)
